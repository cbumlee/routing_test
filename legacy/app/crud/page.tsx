...
export default function CrudPage() {
  ...
  return (
    <div className="p-8 font-sans">
      ...
      <h1 className="text-2xl font-bold mb-4">Legacy CRUD</h1>
      ...
      <div className="mb-8 p-4 border rounded">
        ...
        <div className="mb-4 p-3 rounded text-xs">
          ...
          <code className="block mb-2">{`{"id": 1, "title": "첫 번째 항목", "content": "이것은 첫 번째 테스트 항목입니다"}`}</code>
          <p className="font-bold mb-2">예시 2:</p>
          <code className="block mb-2">{`{"id": 2, "title": "두 번째 항목", "content": "Legacy에서 생성한 데이터입니다"}`}</code>
          <p className="font-bold mb-2">예시 3:</p>
          <code className="block">{`{"id": 3, "title": "세 번째 항목", "content": "CRUD 테스트를 위한 샘플 데이터"}`}</code>
        </div>
